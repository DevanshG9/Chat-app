...
public class ChatWithStrangerDialogFragment  extends DialogFragment {
    ...
    private final ChatWithStrangerDialogFragment.onStrangerNameInputtedListener listener;

    @SuppressLint("ValidFragment")
    public ChatWithStrangerDialogFragment(ChatWithStrangerDialogFragment.onStrangerNameInputtedListener listener) {
